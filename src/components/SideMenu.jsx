        ...
        <div className={styles.sideMenu}>
            ...
            {listState === true ? <div className={styles.fileList}>
                ...
                <div className={styles['add-btn']}>
                        <svg t="1687939779439" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5417" width="20" height="20"><path d="M512 992C246.912 992 32 777.088 32 512 32 246.912 246.912 32 512 32c265.088 0 480 214.912 480 480 0 265.088-214.912 480-480 480z m0-64c229.76 0 416-186.24 416-416S741.76 96 512 96 96 282.24 96 512s186.24 416 416 416z" fill="#000000" p-id="5418"></path><path d="M256 544a32 32 0 0 1 0-64h512a32 32 0 0 1 0 64H256z" fill="#000000" p-id="5419"></path><path d="M480 256a32 32 0 0 1 64 0v512a32 32 0 0 1-64 0V256z" fill="#000000" p-id="5420"></path></svg>
                </div>
            </div> : null}
        </div>
    </>
