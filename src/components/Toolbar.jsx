...
function Toolbar(props){
    const { filename, modifyfilename, contentFormat, contentAlign, fontFormat} = props
    ...
    const changeFontFormat = (fontType) => {
        fontFormat({
            startOffset: range.current.startOffset, 
            endOffset: range.current.endOffset, 
            startTarget: range.current.startContainer.parentNode.getAttribute('data-key'), 
            endTarget: range.current.endContainer.parentNode.getAttribute('data-key'),
            'fontType': fontType
        })
    }
    const recordRange = () => {
        try {
            range.current = window.getSelection().getRangeAt(0)
        } catch (error) {
            range.current = null
        }
    }
    return<div className={styles.toolbar}>
        ...
        <div className={styles['context-tools']}>
            <div className={styles['pre-font']}>
                <div className={styles.icon}>
                    <span>
                        <svg t="1687790189452" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1774" width="20" height="20"><path d="M100.992 64l822.016 0 0 277.44-36.352 0c0 0-69.376-169.408-151.232-184.192-81.856-14.784-138.752-4.608-138.752-4.608L595.648 859.968c0 0 22.72 47.808 60.224 51.2l83.008 0L738.88 960 285.184 960l1.152-50.048L359.04 908.8c0 0 54.592-17.088 54.592-56.896 0-39.744 1.152-693.568 1.152-693.568S324.992 145.92 278.336 157.312C231.744 168.64 149.824 236.864 137.344 336.896L100.992 338.048 100.992 64z" fill="#1296db" p-id="1775"></path></svg>
                    </span>
                </div>
            ...
            <div className={styles['align-content']}>
                <div className={styles.icon}>
                    <span>
                        <svg t="1687793345501" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4831" width="20" height="20"><path d="M96 128h832v96H96zM96 576h832v96H96zM96 352h576v96H96zM96 800h576v96H96z" p-id="4832"></path></svg>
                    </span>
                </div>
                <div className={styles['dropdown-btn']}>
                    <span>
            ...
            <div className={styles['oddbtn-container']}>
                <div className={styles['bold-icon']} onClick={changeFontFormat.bind(this, 'bold')} onMouseEnter={recordRange}>
                    <span>
                        <svg t="1687797823252" className="bold-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8165" width="20" height="20"><path d="M768.96 575.072c-22.144-34.112-54.816-56.8-97.984-68.032v-2.176c22.88-10.88 42.112-23.04 57.696-36.48 15.616-12.704 27.584-26.144 35.936-40.288 16.32-29.76 24.128-60.96 23.392-93.632 0-63.872-19.776-115.232-59.328-154.08-39.2-38.464-97.824-58.048-175.84-58.784H215.232v793.728H579.52c62.432 0 114.496-20.864 156.256-62.624 42.112-39.936 63.52-94.176 64.224-162.752 0-41.376-10.336-79.68-31.04-114.88zM344.32 228.832h194.912c43.904 0.736 76.224 11.424 96.896 32.128 21.056 22.144 31.584 49.184 31.584 81.12s-10.528 58.432-31.584 79.488c-20.672 22.848-52.992 34.304-96.896 34.304H344.32V228.832z m304.352 536.256c-20.672 23.584-53.344 35.744-97.984 36.48H344.32v-238.432h206.336c44.64 0.704 77.312 12.512 97.984 35.392 20.672 23.232 31.04 51.168 31.04 83.84 0 31.904-10.336 59.488-31.008 82.72z" p-id="8166"></path></svg>
                    </span>
                </div>
                <div className={styles['italic-icon']} onClick={changeFontFormat.bind(this, 'italic')} onMouseEnter={recordRange}>
                    <span>
                        <svg t="1687798574842" className="italic-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9179" width="20" height="20"><path d="M768 85.792h-288a32 32 0 0 0 0 64h96.32l-230.336 704H256a32 32 0 0 0 0 64h288a32 32 0 0 0 0-64h-93.728l230.528-704H768a32 32 0 0 0 0-64z" p-id="9180"></path></svg>
                    </span>
                </div>
                <div className={styles['underline-icon']} onClick={changeFontFormat.bind(this, 'underline')} onMouseEnter={recordRange}>
                    <span>
                        <svg t="1687799073957" className="underline-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12991" width="20" height="20"><path d="M512 811.296a312 312 0 0 0 312-312V89.6h-112v409.696a200 200 0 1 1-400 0V89.6h-112v409.696a312 312 0 0 0 312 312zM864 885.792H160a32 32 0 0 0 0 64h704a32 32 0 0 0 0-64z" p-id="12992"></path></svg>
                    </span>
                </div>
                <div className={styles['delline-icon']} onClick={changeFontFormat.bind(this, 'delline')} onMouseEnter={recordRange}>
                    <span>
                        <svg t="1687798848627" className="delline-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11248" width="20" height="20"><path d="M1024 511.81H687.11c-38.48-16.41-94.03-35.49-167.45-57.37-77.09-22.34-126.25-39.09-146.36-50.27-45.8-24.57-68.14-56.98-68.14-97.18 0-45.82 18.98-79.32 56.98-101.66 33.5-20.11 79.32-29.07 138.52-29.07 64.8 0 115.07 13.41 150.82 42.45 34.64 27.93 56.98 70.39 67.05 128.48H809c-7.82-83.77-37.98-147.45-91.61-189.91C666 115.94 594.5 95.83 505.14 95.83c-82.68 0-150.82 17.89-203.34 53.64-59.2 37.98-88.25 92.73-88.25 161.98 0 67.05 30.16 118.43 91.61 154.18 19.87 10.38 61.41 26.15 123.58 46.19H0v93.09h681.64c35.63 26.24 54.75 59.59 54.75 100.93 0 42.43-20.11 75.95-60.32 100.55-40.23 24.57-93.84 36.86-158.66 36.86-71.5 0-125.11-15.64-161.98-44.68-40.23-32.41-64.8-83.8-72.61-153.07h-90.5c6.7 98.32 41.34 170.93 103.91 218.98 53.61 40.2 127.34 60.32 221.18 60.32 94.98 0 169.82-20.11 225.68-59.2 55.86-40.23 83.8-96.09 83.8-165.34 0-35.82-8.24-67.53-24.42-95.34H1024v-93.11z" p-id="11249"></path></svg>
                    </span>
                </div>
            </div>
            <div className={styles['cut-off-rule']}></div>
            <div className={styles['fontcolor-container']}>
                <div className={styles['fontcolor-icon']}>
                    <span>
                        <svg t="1687802341367" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8117" width="20" height="20" data-spm-anchor-id="a313x.7781069.0.i24"><path d="M839 768H735.3l-74.1-192.7H358.6L288.7 768H185L461.8 64h100.4L839 768zM632.1 495.8L522.3 203.1c-3.4-9.4-7.2-25.7-11.3-49.1h-2.3c-3.4 21.2-7.4 37.6-11.7 49.1L388.1 495.8h244z" fill="#2c2c2c" p-id="8118"></path><path d="M64 832h896v128H64z" fill="#2c2c2c" p-id="8119"></path></svg>
                    </span>
                </div>
                <div className={styles['color-Prompter']}></div>
            </div>
            <div className={styles['backgroundcolor-container']}>
                <div className={styles['backgroundcolor-icon']}>
                    <span>
                        <svg t="1687802530354" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11695" width="20" height="20"><path d="M96 768h832v160H96z" fill="#2c2c2c" p-id="11696" data-spm-anchor-id="a313x.7781069.0.i34"></path><path d="M443.862627 224.692457m45.254834 45.254834l135.764502 135.764502q45.254834 45.254834 0 90.509668l-135.764502 135.764502q-45.254834 45.254834-90.509668 0l-135.764502-135.764502q-45.254834-45.254834 0-90.509668l135.764502-135.764502q45.254834-45.254834 90.509668 0Z" fill="#FFFFFF" p-id="11697"></path><path d="M398.176 225.088L318.976 145.92 364.224 100.64l118.304 118.272c2.272 1.76 4.48 3.68 6.592 5.76l181.024 181.024a64 64 0 0 1 0 90.496l-181.024 181.024a64 64 0 0 1-90.528 0L217.6 496.192a64 64 0 0 1 0-90.496l180.576-180.608z m170.144 169.28l-0.448 0.416-124.416-124.416-175.136 175.104h351.104L568.32 394.368zM752 704a80 80 0 0 1-80-80c0-44.16 67.68-124.672 80-124.672 12.32 0 80 80.48 80 124.672a80 80 0 0 1-80 80z" fill="#2c2c2c" p-id="11698" data-spm-anchor-id="a313x.7781069.0.i35"></path></svg>
                    </span>
                </div>
                <div className={styles['color-Prompter']}></div>
            </div>
            <div className={styles['cut-off-rule']}></div>
            <div className={styles['undoredobtn-container']}>
                <div className={styles['undo-icon']}>
                    <span>
                        <svg t="1687800323277" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="14039" width="20" height="20"><path d="M237.303467 377.216l113.152 106.026667c16.584533 16.763733 33.6512 43.933867 17.066666 60.693333-16.597333 16.759467-39.227733 16.759467-55.816533 0L138.368 368.3968c-13.162667-13.2608-14.122667-34.491733-0.96-47.752533l174.301867-178.2784c16.5888-16.759467 39.223467-16.759467 55.812266 0s-0.477867 43.933867-17.066666 60.689066L238.775467 313.216h380.881066c153.211733 0 276.343467 132.881067 276.343467 285.738667 0 152.853333-123.136 298.845867-276.343467 298.845866H213.457067c-23.317333 0-42.88-10.824533-42.88-34.133333 0-23.313067 19.562667-29.870933 42.88-29.870933h402.816c102.762667 0 215.714133-132.322133 215.714133-234.845867s-112.951467-221.725867-215.714133-221.725867H237.303467z" fill="#333333" p-id="14040"></path></svg>
                    </span>
                </div>
                <div className={styles['redo-icon']}>
                    <span>
                        <svg t="1687800323277" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="14039" width="20" height="20"><path d="M237.303467 377.216l113.152 106.026667c16.584533 16.763733 33.6512 43.933867 17.066666 60.693333-16.597333 16.759467-39.227733 16.759467-55.816533 0L138.368 368.3968c-13.162667-13.2608-14.122667-34.491733-0.96-47.752533l174.301867-178.2784c16.5888-16.759467 39.223467-16.759467 55.812266 0s-0.477867 43.933867-17.066666 60.689066L238.775467 313.216h380.881066c153.211733 0 276.343467 132.881067 276.343467 285.738667 0 152.853333-123.136 298.845867-276.343467 298.845866H213.457067c-23.317333 0-42.88-10.824533-42.88-34.133333 0-23.313067 19.562667-29.870933 42.88-29.870933h402.816c102.762667 0 215.714133-132.322133 215.714133-234.845867s-112.951467-221.725867-215.714133-221.725867H237.303467z" fill="#333333" p-id="14040"></path></svg>
                    </span>
                </div>
